procesar_tweets: procesar_tweets.o bloom_filter.o lib.o hash.o lista.o heap.o pila.o strutil.o

procesar_usuarios: procesar_usuarios.o bloom_filter.o lib.o hash.o lista.o heap.o pila.o strutil.o
